...
import { useStateCreateBranches } from "@/services/branches/create/useStateCreateBranches"

import { useStateEditBranches } from "@/services/branches/edit/useStateEditBranches"
...
export function BranchEditForm({
    ...
    const { isOpen, setIsOpen, isSubmitting, formRef, handleSubmit } =
        useStateEditBranches({ branchId: branch.id, onUpdate })
...
export function BranchCreateForm({ onUpdate }: BranchCreateFormProps) {
    const { isOpen, setIsOpen, isSubmitting, formRef, handleSubmit } =
        useStateCreateBranches({ onUpdate })
